...
function colorSymmetry(type)
{
   ...
   // var color = d3.scaleOrdinal().domain([0, 2, 3, 4, 5, 6, 7,8,9]).range(['gray', 'gray', 'gray', 'gray',  'gray', 'gray', '','#B22222', '#d95f02' ])
...
//Color scale
    ...
    var color = d3.scaleOrdinal().domain([0, 2, 3, 4, 5, 6, 7]).range(['#1b9e77', 'gray', '#7570b3', '#e7298a', '#66a61e', '#e6ab02', '#a6761d']);
